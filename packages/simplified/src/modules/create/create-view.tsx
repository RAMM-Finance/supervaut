     ...
     <div className={inputStyles.AmountInput}>
        ...
        <div className={inputStyles.AmountInputField}>
         ...
         {/* <button className={buttonStyles.BaseNormalButtonTiny}><span>Max</span></button>*/}
          ...
          <span style={{color: 'black', "padding-left": "0.25rem", "padding-right": "0.5rem"}}></span>
...
const CreationAmountInput = ({type, amount, setAmount})=>{
    const titles = ["Address", "Senior Weight"]
    const placeholders = ["enter address ", "Senior weight, in 0 to 1"]
    const istrue = true; 
    return ( 
...
const ParameterInput = ({juniorWeight, setJuniorWeight, promisedReturn, setPromisedReturn, inceptionPrice, setInceptionPrice})=>{
    ...
    return ( 
     ...
     <div className={inputStyles.AmountInput}>
        ...
        <label>Senior Promised Return in APR</label>
...
// css format(block position natural)
    return (
        <>
            ...
            <h1>Step 2: Include Assets to pool and split</h1>

                    <VaultInput  vault = {vault} setVault = {setVault} weight ={weight} setWeight ={setWeight}/> 
            <h1>Step 3: Choose Tranche Parameters</h1>
            ...
            <h1> Step 4 (Optional) : Enter oracle address for asset/underlying</h1>
                    <CreationAmountInput type = {0} amount = {oracleAddress} setAmount = {setOracleAddress}/>
              ...
              {/*  <div>
                ...
                <PrimaryThemeButton action={()=>
                    setModal({
                        ...
                        footer:{
                            text:"Estimated Gas Cost of deployment"
                        }, 
                        breakdowns:
                     [
                        {
                          heading: "What you are creating:",
                          infoNumbers: [
                            {
                              label: "Vault ID",
                              value:"1",
