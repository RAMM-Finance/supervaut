...
contract AnalyticMath {
    ...
    */
    ...
    /**
      * @dev Compute (a / b) ^ (c / d)
    */
    function pow(uint256 a, uint256 b, uint256 c, uint256 d) external view returns (uint256, uint256) { unchecked {
        if (a >= b)
    ...
    /**
      * @dev Compute log(a / b)
    */
    function log(uint256 a, uint256 b) external pure returns (uint256, uint256) { unchecked {
        require(a >= b, "log: a < b");
    ...
    /**
      * @dev Compute e ^ (a / b)
    */
    function exp(uint256 a, uint256 b) external view returns (uint256, uint256) { unchecked {
