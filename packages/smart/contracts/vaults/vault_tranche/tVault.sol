...
abstract contract tVault is ERC4626{
...
//   uint256 oracle_freq = 1; //set default as 1 which is just getting last block's exchange rate (only prevents atomic tx attacks)
//   uint256 lastBlock; 
...
//         }
//         exchange_rate[i+1] = get_fresh_exchange_rate(ins);
//       }

//       else{
//         exchange_rate[0] = get_fresh_exchange_rate(ins); 
//       }
//     }
...
//   		num_asset_for_this = instrument_
//                           .convertToAssets(shares
//                           .mulDivDown(ratios[i], PRICE_PRECISION)); 
...
//   		instrument_.deposit(num_asset_for_this, address(this)); //will mint the instrument to this contract
//   	}
//   }
